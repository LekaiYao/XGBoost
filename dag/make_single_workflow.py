...
def make_dag(out_dir: Path, train_tag: str, with_shap: bool) -> Path:
    ...
    lines = [
        ...
        f'VARS TRAIN train_tag="{train_tag}" job_tag="{train_tag}_train"',
        "",
        "JOB APPLY submit_apply_job.sub",
        f'VARS APPLY train_tag="{train_tag}" job_tag="{train_tag}_apply"',
        "",
    ...
    if with_shap:
        lines.extend(
            [
                ...
                f'VARS SHAP train_tag="{train_tag}" job_tag="{train_tag}_shap"',
                "",
