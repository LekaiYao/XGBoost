...
def resolve_model_path(train_tag):
    return resolve_existing(model_path(train_tag), legacy_model_path(train_tag))


def resolve_scaler_path(train_tag):
    return resolve_existing(scaler_path(train_tag), legacy_scaler_path(train_tag))


def resolve_model_config_path(train_tag):
    return resolve_existing(model_config_path(train_tag), legacy_model_config_path(train_tag))
